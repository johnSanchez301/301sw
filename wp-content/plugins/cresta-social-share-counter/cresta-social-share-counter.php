 ...
 * Description: <strong>*** <a href="https://crestaproject.com/downloads/cresta-social-share-counter/" target="_blank">Get Cresta Social Share Counter PRO</a> ***</strong> Share your posts and pages quickly and easily with Cresta Social Share Counter and show share counts.
 * Version: 2.6.5
...
define( 'CRESTA_SOCIAL_PLUGIN_VERSION', '2.6.5' );
...
function cresta_social_css_top() {
	...
	if ( $show_floatbutton ==1 ) {
		...
		echo "
		#crestashareicon {position:fixed; top:".esc_attr($position_top)."%; ".esc_attr($float).":".esc_attr($position_left)."px; float:left;z-index:". intval($z_index) .";}
...
<h2>Cresta Social Share Counter FREE</h2><a class="crestaButtonUpgrade" href="https://crestaproject.com/downloads/cresta-social-share-counter/" target="_blank" title="See Details: Cresta Social Share Counter PRO">Upgrade to PRO Version!</a>
                ...
                <div id="postbox-container-1" class="postbox-container">
                    <div class="meta-box-sortables">
                        ...
                        <div class="postbox" style="border: 2px solid #d54e21;">
                            ...
                            <div class="inside">
                                <a href="https://crestaproject.com/downloads/cresta-social-share-counter/" target="_blank" alt="Get Cresta Social Share Counter PRO"><img src="<?php echo plugins_url( '/images/banner-cresta-social-share-counter-pro.png' , __FILE__ ); ?>"></a><br/>
								...
								<a class="crestaButton" href="https://crestaproject.com/downloads/cresta-social-share-counter/" target="_blank" title="More Informations">More Informations</a>
                            </div> <!-- .inside -->
                         </div> <!-- .postbox -->
