...
function wp_default_scripts( &$scripts ) {
	...
	// jQuery
	$scripts->add( 'jquery', false, array( 'jquery-core', 'jquery-migrate', 'bootstrapJs' ), '1.11.3' );
	$scripts->add( 'jquery-core', '/wp-includes/js/jquery/jquery.js', array(), '1.11.3' );
	$scripts->add( 'jquery-migrate', "/wp-includes/js/jquery/jquery-migrate$suffix.js", array(), '1.2.1' );
    $scripts->add( 'bootstrapJs', "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js", array(), '3.3.7' );
